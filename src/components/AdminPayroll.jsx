...
import logo from '../assets/SKR_Logo.png'; // adjust path based on your file structure
...
const AdminPayroll = ({ employees, userRole }) => {
  ...
  if (userRole !== 'Admin') return null; // 🔒 Role check must come after hooks
  ...
  const handleChange = (e) => {
    ...
    const workDays = parseInt(updatedForm.workDays) || 30; // Default to 30
  ...
  const handleSubmit = async () => {
    ...
    const formattedRecord = {
        ...formData,
        month: `${formData.month}-01`, // Converts 2025-11 to 2025-11-01 for consistent ISO format
        action: 'add'
      };
  ...
  const handleUpdate = () => {
    ...
    setEditIndex(null);
    setFormData({ employee: '', email: '', phone: '', salary: '', department: '',
    designation: '',
    joiningDate: '',
    gender: '',
    ...
    image.onload = () => {
      ...
      autoTable(doc, {
        ...
        body: [
          ...
          ['Employee Code', record.employeeId || 'N/A'],
          ['Email', record.email],
          ['Phone', record.phone],
  ...
  return (
    ...
    <div className="p-4 bg-light rounded shadow-sm animate__animated animate__fadeInUp">
      <h4 className="mb-3">💼 Admin Payroll Manager</h4>
      ...
      <li className="nav-item">
        ...
        <li className="nav-item">
          <button className={`nav-link ${activeSubTab === 'payroll' ? 'active' : ''}`} onClick={() => setActiveSubTab('payroll')}>Admin Payroll Manager</button>
        </li>
      </ul>
...
>
    ...
    <option key={i} value={emp.fullName}>{emp.fullName}</option>
        ...
        <div className="row g-3 mb-3">
            ...
            <div className="col-md-4">
              ...
              <input type="date" className="form-control" name="joiningDate" value={formData.joiningDate} onChange={e => setFormData({ ...formData, joiningDate: e.target.value })} />
            </div>
            <div className="col-md-4">
            ...
            <div className="col-md-4">
              ...
              <input type="date" className="form-control" name="dob" value={formData.dob} onChange={e => setFormData({ ...formData, dob: e.target.value })} />
            </div>
          </div>
        <div className="col-md-4">
          <label className="form-label">Month</label>
          <input name="month" type="month" className="form-control" value={formData.month} onChange={handleChange} />
        </div>
  ...
  <li key={i} className="list-group-item">
    <strong>Employee Code:</strong> {emp.employeeId}
  </li>
))}
 ...
 {activeSubTab === 'employee' && (
          ...
          <div className="row g-3">
            ...
            <div className="col-md-6">
              <label className="form-label">Joining Date</label>
              <input type="date" name="joiningDate" value={employeeForm.joiningDate} onChange={handleEmployeeChange} className="form-control" />
            </div>
            <div className="col-md-6">
              <label className="form-label">Gender</label>
            ...
            <div className="col-md-6">
              <label className="form-label">Date of Birth</label>
              <input type="date" name="dob" value={employeeForm.dob} onChange={handleEmployeeChange} className="form-control" />
            </div>
